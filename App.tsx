...
const TagIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.593l6.25-2.143c.826-.283.98-1.407.593-1.992l-9.581-9.581A2.25 2.25 0 009.568 3z" />
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-6">
                    <MetricCard 
                      title="Hook Strength" 
                      value={analysisResult.hookStrength} 
                      icon={<HookIcon />} 
                      tooltip="Higher scores indicate a stronger, more attention-grabbing opening."
                    />
                    <MetricCard 
                      title="Pain Point Clarity" 
                      value={analysisResult.painPointClarity} 
                      icon={<PainIcon />} 
                      tooltip="Higher scores indicate a clear identification and addressing of customer problems."
                    />
                    <MetricCard 
                      title="CTA Strength" 
                      value={analysisResult.ctaStrength} 
                      icon={<CtaIcon />} 
                      tooltip="Higher scores indicate a clear, compelling, and urgent call to action."
                    />
                    <MetricCard 
                      title="'You' Usage" 
                      value={analysisResult.youUsageCount} 
                      unit="" 
                      icon={<UserIcon />} 
                      maxValue={1} 
                    />
                    ...
                    <MetricCard 
                      ...
                      value={analysisResult.salesKeywordCount} 
                      unit="" 
                      icon={<TagIcon />} 
                      maxValue={1} 
                      tooltip="Count of power words like 'free', 'discount', 'guarantee', 'now', etc."
                    />
                  </div>
                </div>
                <div className="mt-10">
